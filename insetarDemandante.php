...
/*
  ...
  $rutaArch
  */
 $query = "INSERT denunciante values (NULL,'$nombre','$apePat','$apeMat','$edad','$sexo','$telefono','$correo','img/perfil/foto.png');";
...
*/
  ...
  $calle = $_POST["Calle"];
  $numero = $_POST["Numero"];
 $query2 = "INSERT reporte VALUES (NULL,NOW(),'$Depa',(select MAX(denunciante.IdDenunciante) from denunciante),'$Ubicacion','$Denun','img/repo/calle.png','$calle','$numero',1)";
